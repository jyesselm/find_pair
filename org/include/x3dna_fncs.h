void populate_nt_info(long num_residue, long** seidx, char** ResName, char* ChainID, long* ResSeq,
                      char** Miscs, char* bseq, char** nt_info);
void populate_nt_list(long num_residue, long** seidx, long* RY, char* bseq, char** AtomName,
                      double** xyz, long** nt_list);
long** read_input(char* inpfile, char* pdbfile, char* outfile, long* ds, long* num_bp, long* ip,
                  long* hetatm);
...
void output_Borg_P_C1_C4(long num_residue, double** org, double** xyz, long** nt_list,
                         char** nt_info);
void atom_list(long ds, long num_bp, long** pair_num, long** seidx, long* RY, char** bp_seq,
               char** AtomName, char** ResName, char* ChainID, long* ResSeq, char** Miscs,
               long** phos, long** c6_c8, long** sugar, long** chi);
void get_nt_torsion(long num_residue, double** org, double** xyz, long** nt_list,
                    double** nt_torsion);
void get_ss_Zp_Dp(long num_residue, double** org, double** orien, double** xyz, long** nt_list,
                  double** ss_Zp_Dp);
void output_nt_torsion(long num_residue, char** nt_info, long** nt_list, double** nt_torsion,
                       double** ss_Zp_Dp, FILE* fp);
void get_nt_bb_torsion(double** nt_bb_torsion, long num_residue, long** seidx, long* RY,
                       char** AtomName, char** ResName, char* ChainID, long* ResSeq, char** Miscs,
                       double** xyz);
...
void p_c1_dist(long ds, long num_bp, char** bp_seq, long** phos, long** chi, double** xyz,
               long* bphlx, FILE* fp);
...
void groove_width(long parallel, long num_bp, char** bp_seq, long** phos, double** xyz, long* bphlx,
                  FILE* fp);
...
void ref_frames(long ds, long num_bp, long** pair_num, char** bp_seq, long** seidx, long* RY,
                char** AtomName, char** ResName, char* ChainID, long* ResSeq, char** Miscs,
                double** xyz, FILE* fp, double** orien, double** org, long* WC_info, long* str_type,
                long irna, long** o3p_brk);
...
void get_parameters(long ds, long num_bp, char** bp_seq, double** orien, double** org,
                    ...
                    double* mst_org, double* mst_orienH, double* mst_orgH, long* bphlx, long istart,
...
void write_mst(long ds, long num_bp, long** pair_num, char** bp_seq, double* mst_orien,
               double* mst_org, long** seidx, char** AtomName, char** ResName, char* ChainID,
               long* ResSeq, double** xyz, char** Miscs, long** htm_water, double** twist_rise,
               char* strfile);
...
void str_classify(double twist_p, double twist_n, long str_type, long parallel, long num_bp,
                  FILE* fp);
double a_hlxdist(long idx, double** xyz, double* hlx_axis, double* hlx_pos);
void print_radius(char** bp_seq, long nbpm1, long ich, double** p_radius, double** o4_radius,
                  double** c1_radius, long* bphlx, FILE* fp);
void helix_radius(long ds, long num_bp, char** bp_seq, double** orien, double** org, long** phos,
                  long** chi, double** xyz, long* bphlx, FILE* fp);
void print_shlx(char** bp_seq, long nbpm1, long ich, double* shlx_orien, double* shlx_org,
                FILE* fp);
void get_helix_axis(long ds, long num_bp, char** bp_seq, double** orien, double** org, long* bphlx,
                    FILE* fp);
void get_axis(long nvec, long** idx, long num, double** xyz, long nb, long* C1b, long* C1e,
              double* std_rise, double* hrise, double* haxis, double* hstart, double* hend);
void print_poc_r3d(double* rave, double* hstart, double* hend);
void global_analysis(long ds, long num_bp, long num, char** bp_seq, long** chi, long** phos,
                     double** xyz, FILE* fp);
void base_overlap(long ds, long num_bp, long num, long num_residue, long** pair_num, long* bRY,
                  char** bp_seq, long** seidx, char** AtomName, double** xyz, long* idx,
                  double** orien, double** org, FILE* fp);
...
void ring_oidx(long num, long num_residue, long* RY, long** seidx, char** AtomName, double** xyz,
               long* idx, long** ring_atom);
void get_cntatom(long* ringlist, long** connect, long* idx);
double get_oarea(long r1, long r2, long** ring_atom, double* oave, double* zave, double** xyz,
                 long only_ring);
...
void cehs_bppar(double** rot1, double* org1, double** rot2, double* org2, double* pars,
                double** mst_orien, double* mst_org);
void cehs_pars(long num_bp, long istart, long istep, long** pair_num, char** bp_seq, long** seidx,
               long** c6_c8, long* RY, char** AtomName, char** ResName, char* ChainID, long* ResSeq,
               char** Miscs, double** xyz, double* bp_orien, double* bp_org, FILE* fp);
...
void base_frame(long num_residue, char* bseq, long** seidx, long* res_type, char** AtomName,
                char** ResName, char* ChainID, long* ResSeq, char** Miscs, double** xyz, char* BDIR,
                double** orien, double** org);
void peptide_info(long num_residue, long** seidx, char** AtomName, char** ResName, char* ChainID,
                  long* ResSeq, char** Miscs, double** xyz, long* res_type, long* cidx,
                  long* mchain);
void base_blks(long num_residue, long* res_type, double** orien, double** org, char* bseq,
               char* BDIR, char* alcfile);
...
void peptide_frame(long num_residue, char* BDIR, long* res_type, long* mchain, double** xyz,
                   double** orien, double** org);
...
void get_AA_frames(long num_residue, long** seidx, long* res_type, char** AtomName, char** ResName,
                   char* ChainID, long* ResSeq, char** Miscs, double** xyz, char* BDIR,
                   double** orien, double** org);
...
void get_planarFrame(char* aa, long pnum, char* planar_atoms[], char* BDIR, char* idmsg, long ib,
                     long ie, char** AtomName, double** xyz, double* orien_i, double* org_i);
void get_argFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_pheFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_tyrFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_trpFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_hisFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_lysFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_asnFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_glnFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_aspFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_gluFrame(char* BDIR, char* idmsg, long ib, long ie, char** AtomName, double** xyz,
                  double* orien_i, double* org_i);
void get_planarAA_frames(long num_residue, long** seidx, char** AtomName, char** ResName,
                         char* ChainID, long* ResSeq, char** Miscs, double** xyz, long* res_type,
                         long* cidx);
...
void print_resid(long num_residue, long** seidx, char** ResName, char* ChainID, long* ResSeq,
                 char** Miscs, long* res_type);
...
void get_snap_par(double** rot1, double* org1, double** rot2, double* org2, char* direction,
                  double* trs_dist, double* rot_dist, double* pars, double* orgP, double** rotP);
void write_snap_par(FILE* fp, char* direction, double dist, double rot_ang, double* pars,
                    double* orgP, double** rotP);
void write_atom_xyz(FILE* fp, char* fmt, double* xyz, double dft);
long set2frame(long inum, long* ivec, long** seidx, double** xyz, double* morg, double** mst,
               long* serial, double** xyz_pair);
long set2frameCa(long inum, long* ivec, long** seidx, long* res_type, char** AtomName, double** xyz,
                 double* morg, double** mst, long* serial, double** xyz_pair);
long get_nextModelNumber(char* pdbfile);
void output_naa_str(char* filename, char* fmode, char* idmsg, long num, long* serial,
                    char** AtomName, char** ResName, char* ChainID, long* ResSeq, double** xyz_pair,
...
void refs_right_left(long bnum, double** orien, double** org, double** r1, double* o1, double** r2,
                     double* o2);
void refs_i_j(long b1, long b2, double* bp_orien, double* bp_org, double** r1, double* o1,
              double** r2, double* o2);
...
void pair2mst(long inum_base, long* ivec, char** AtomName, char** ResName, char* ChainID,
              long* ResSeq, char** Miscs, double** xyz, double** orien, double** org, long** seidx,
              double* mst_orien, double* mst_org, long** htm_water, miscPars* misc_pars, FILE* fp);
void get_chi_angle(long num_residue, long* RY, char* bseq, long** seidx, double** xyz,
                   char** AtomName, char** ResName, char* ChainID, long* ResSeq, char** Miscs,
                   double* chi, long** idxCN);
...
void normalize_resName_atomName(long is_dna, const char* rname0, const char* aname0, char* rname,
                                char* aname);
...
void write_pdb(long num, char** AtomName, char** ResName, char* ChainID, long* ResSeq, double** xyz,
               char** Miscs, char* pdbfile);
void write_mmcif(long num, char** AtomName, char** ResName, char* ChainID, long* ResSeq,
                 double** xyz, char* pdbfile);
...
void residue_wtype(long num_residue, long** seidx, char** ResName, char** AtomName, double** xyz,
                   char** Miscs, long* res_type, long only_ntaa);
...
void get_seq(long num_residue, long** seidx, char** AtomName, char** ResName, char* ChainID,
             long* ResSeq, char** Miscs, double** xyz, char* bseq, long* RY);
void get_bpseq(long ds, long num_bp, long** pair_num, long** seidx, char** AtomName, char** ResName,
               char* ChainID, long* ResSeq, char** Miscs, double** xyz, char** bp_seq, long* RY);
...
void read_alc(char* alcname, long* num, long* nbond, char** AtomName, double** xyz, long* ibase,
              long** linkage);
void write_alc(long num, long nbond, char** AtomName, double** xyz, long* ibase, long** linkage,
               char* alcfile);
void free_alc(long num, long nbond, char** AtomName, double** xyz, long* ibase, long zero_1,
              long** linkage);
void cnct_org(long num_bp, long ia, long ib, char** tAtomName, double** txyz, long* tibase,
              long** tlinkage, double** org_xyz);
...
void get_fig_xy(long num, double** xyz, long nO, double** oxyz, long* urxy, long frame_box,
                FILE* fp);
void get_pxy(double* xy1, double* xy2, double r, double* px, double* py);
void alc2fig(long nobj, long* idx, long* depth, long** allobj, double** blkxyz, double** oxyz,
             long* ibase, long faces[][5], long* opts, FILE* fp);
void get_ps_xy(char* imgfile, long* urxy, long frame_box, FILE* fp);
void alc2ps(long nobj, long* idx, long** allobj, double** blkxyz, double** oxyz, long* ibase,
            long faces[][5], long* opts, FILE* fp);
void bring_atoms(long ib, long ie, long ra_num, char** AtomName, long* nmatch, long* batom);
void all_bring_atoms(long num_residue, long* RY, long** seidx, char** AtomName, long* num_ring,
                     long** ring_atom);
...
void raster3d_header(long num, double** xyz, double scale_factor, long no_header, long frame_box,
                     FILE* fp);
...
void fill_base_ring(long num_residue, long num_ring, long** ring_atom, double** xyz, long* ibase,
                    char* bseq, double** base_col, char* label_style, long label_ring, long* ResSeq,
                    FILE* fp);
void process_alc(char* alcfile, char* imgfile, double scale_factor, long* opts);
void alc_3images(long* opts, long nobj, long num_blk, long num_blk8, long nO_lkg, long nO,
                 double** oxyz, double** blkxyz, long* blkibase, long** linkage,
...
void get_fig_pars(double* dot_sep, long* dlcol, long* dwidth, long* bp1width, long* bp2width,
                  long** bc_idx, double* msat, double* Msat, long* o_sides, long* line_width,
                  long* join_style, long* cap_style, long* mfcol);
...
void add_3axes(long* num, char** AtomName, long* ibase, double** xyz, long* nbond, long** linkage,
               long side_view, double axis_len);
...
void combine_pstnd2(long num_bp, char** bp_seq, long** s2idx, long* tnum, char** tAtomName,
                    char** tResName, char* tChainID, long* tResSeq, double** txyz,
                    char** tAtomName2, double** txyz2);
void reverse_stnd2(long num_bp, char** bp_seq, long** s2idx, long* tnum, char** tAtomName,
                   char** tResName, char* tChainID, long* tResSeq, double** txyz, char** tAtomName2,
...
void base_str(char chain_id, long res_seq, char* misc, char* rname, char bcode, long stnd,
              char* idmsg);
void write_lkglist(long nbond, long** linkage, char** AtomName, char** ResName, char* ChainID,
                   long* ResSeq, char** Miscs);
void hbond_info(long** pair_num, char* bseq, long** seidx, long* idx, char** AtomName,
                char** ResName, char* ChainID, long* ResSeq, char** Miscs, double** xyz, long* RY,
                long* num_hbond, long** hb_linkage);
void hbond_pdb(long num, long num_residue, char* bseq, long** seidx, long* idx, long* RY,
               char** AtomName, char** ResName, char* ChainID, long* ResSeq, char** Miscs,
               double** xyz, long* num_hbond, long** hb_linkage, long pwise);
void hbond_list(long i, long j, char** AtomName, char** ResName, char* ChainID, long* ResSeq,
                double** xyz, char** Miscs, char* bseq, long** seidx, long* idx, long** hb_linkage,
                miscPars* misc_pars, long** num_list, long* num_hbond, long ilayer, FILE* fph);
void hb_numlist(long i, long j, char basei, char basej, long** seidx, long* idx, char** AtomName,
                double** xyz, miscPars* misc_pars, long* num_hb, long** num_list);
...
void hb_atompair(long num_hbonds, char** hb_atom1, char** hb_atom2, double* hb_dist, long* lkg_type,
                 miscPars* misc_pars);
long validate_hbonds(long num_hbonds, double* hb_dist, long* lkg_type, char* hb_type, char basei,
                     char basej, char** hb_atom1, char** hb_atom2);
void get_hbond_ij(long i, long j, char basei, char basej, miscPars* misc_pars, long** seidx,
                  long* idx, char** AtomName, double** xyz, char* hb_info);
...
void get_bonds(long num, char** AtomName, double** xyz, long num_residue, long* RY, long** seidx,
               long** connect);
...
void identify_htw(long num_residue, long** seidx, long* RY, char** AtomName, char** ResName,
                  char* ChainID, long* ResSeq, char** Miscs, double** xyz, long** htm_water);
long attached_residues(long inum_base, long* ivec, long* ivec2, long** seidx, double** xyz,
                       long** htm_water, miscPars* misc_pars);
void print_pairinfo(long i, long j, char basei, char basej, double* rtn_val, double* chi,
                    miscPars* misc_pars, long** seidx, long* idx, char** AtomName, double** xyz,
                    char* bseq, long detailed, FILE* fp);
void check_pair(long i, long j, char* bseq, long** seidx, double** xyz, double** NC1xyz,
                double** orien, double** org, long* idx, char** AtomName, miscPars* misc_pars,
                double* rtn_val, long* bpid, long** ring_atom, long network);
void o3_p_xyz(long ib, long ie, char* aname, char** AtomName, double** xyz, double* o3_or_p,
              long idx);
long is_baseatom(char* atomname);
void base_info(long num_residue, char* bseq, long** seidx, long* RY, char** AtomName,
               char** ResName, char* ChainID, long* ResSeq, char** Miscs, double** xyz,
               double** orien, double** org, double** NC1xyz, double** o3_p);
...
void link_o3_p(long num_residue, long** seidx, char** AtomName, double** xyz, char* ChainID,
               long** connect);
void atom_lkg(long num, char** AtomName, char** ResName, char* ChainID, long* ResSeq, double** xyz,
              char* outfile);
void atomic_pdb1(long num_bp, long num_atoms, long num_max_per_residue, long is_helical, long xdir,
...
void atomic_pdb2(long parallel, long num_bp, long num_atoms, long num_max_per_residue,
                 long is_helical, long xdir, char** bp_seq, double** bp_par, double** step_par,
                 char* BDIR, char* outfile);
void base_c1_atoms(char** AtomName, long ib, long ie, long* num_batom, long* batom);
void extract_base_atoms(long num, char** AtomName, double** xyz, long* bnum, char** bAtomName,
                        double** bxyz);
void atomic_base_p(long parallel, long num_bp, long num_atoms, long num_max_per_residue,
                   long is_helical, long xdir, char** bp_seq, double** bp_par, double** step_par,
                   char* BDIR, long* pidx, char* outfile);
void num_PDB_atoms(long num_bp, long is_single, char** bp_seq, char* BDIR, long* num_atoms,
                   long* num_max_per_residue);
void set_bp_pdb(long num_max_per_residue, char* fname1, char* fname2, double* param, long xdir,
                long* num1, long* num2, char** AtomName1, char** AtomName2, double** xyz1,
                double** xyz2, char ap);
...
void block_alc2(long num_bp, long is_helical, long xdir, char** bp_seq, double** bp_par,
                double** step_par, char* BDIR, char* outfile);
void set_bp_alc(char* fname1, char* fname2, double* param, long xdir, long num, long nbond,
                double** bp_xyz, char ap);
