...
constexpr AtomType RING_ATOM_TYPES[NUM_RING_ATOM_TYPES] = {
    AtomType::C4, AtomType::N3, AtomType::C2,
...
[[nodiscard]] inline const char* to_string(AtomType type) {
    switch (type) {
        ...
        // Amino acid backbone
        case AtomType::N: return "N";
        case AtomType::CA: return "CA";
        case AtomType::C: return "C";
        case AtomType::O: return "O";
        case AtomType::OXT: return "OXT";
        // Common side chain atoms
        case AtomType::CB: return "CB";
        case AtomType::CG: return "CG";
        case AtomType::CG1: return "CG1";
        case AtomType::CG2: return "CG2";
        case AtomType::CD: return "CD";
        case AtomType::CD1: return "CD1";
        case AtomType::CD2: return "CD2";
        case AtomType::CE: return "CE";
        case AtomType::CE1: return "CE1";
        case AtomType::CE2: return "CE2";
        case AtomType::CE3: return "CE3";
        case AtomType::CZ: return "CZ";
        case AtomType::CZ2: return "CZ2";
        case AtomType::CZ3: return "CZ3";
        case AtomType::CH2: return "CH2";
        case AtomType::OG: return "OG";
        case AtomType::OG1: return "OG1";
        case AtomType::OD1: return "OD1";
        case AtomType::OD2: return "OD2";
        case AtomType::OE1: return "OE1";
        case AtomType::OE2: return "OE2";
        case AtomType::OH: return "OH";
        case AtomType::ND1: return "ND1";
        case AtomType::ND2: return "ND2";
        case AtomType::NE: return "NE";
        case AtomType::NE1: return "NE1";
        case AtomType::NE2: return "NE2";
        case AtomType::NH1: return "NH1";
        case AtomType::NH2: return "NH2";
        case AtomType::NZ: return "NZ";
        case AtomType::SD: return "SD";
        case AtomType::SG: return "SG";
        // Water
        case AtomType::OW: return "OW";
        case AtomType::COUNT: return "COUNT";
    }
    return "UNKNOWN";
}
