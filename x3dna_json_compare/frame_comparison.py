...
def compare_frames(legacy_records: List[Dict], modern_records: List[Dict],
    ...
    # Match by key (common keys in both legacy and modern)
    common_bf_keys = set(legacy_base_frame.keys()) & set(modern_base_frame.keys())
    common_ls_keys = set(legacy_ls_fitting.keys()) & set(modern_ls_fitting.keys())
    common_fc_keys = set(legacy_frame_calc.keys()) & set(modern_frame_calc.keys())
    
    # All keys to compare for each type
