...
private:
    ...
    struct PairSelectionState {
        ...
        explicit PairSelectionState(int max_idx) : matched_indices(max_idx + 1, false) {}
    ...
    [[nodiscard]] bool try_select_mutual_pair(int legacy_idx1, int legacy_idx2, const core::Residue* res1,
                                              const core::Residue* res2, const ValidationResult& result,
                                              const PartnerSearchContext& ctx, PairSelectionState& state) const;
};
