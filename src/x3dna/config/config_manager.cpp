...
void ConfigManager::load_from_json(const nlohmann::json& json) {
    ...
    if (json.contains("thresholds")) {
        ...
        if (thresh.contains("min_dorg")) thresholds_.min_dorg = thresh["min_dorg"];
        if (thresh.contains("max_dorg")) thresholds_.max_dorg = thresh["max_dorg"];
        if (thresh.contains("min_dv")) thresholds_.min_dv = thresh["min_dv"];
        if (thresh.contains("max_dv")) thresholds_.max_dv = thresh["max_dv"];
        if (thresh.contains("min_dNN")) thresholds_.min_dNN = thresh["min_dNN"];
        if (thresh.contains("max_dNN")) thresholds_.max_dNN = thresh["max_dNN"];
        if (thresh.contains("min_plane_angle")) thresholds_.min_plane_angle = thresh["min_plane_angle"];
        if (thresh.contains("max_plane_angle")) thresholds_.max_plane_angle = thresh["max_plane_angle"];
        if (thresh.contains("min_base_hb")) thresholds_.min_base_hb = thresh["min_base_hb"];
        if (thresh.contains("hb_lower")) thresholds_.hb_lower = thresh["hb_lower"];
        if (thresh.contains("hb_dist1")) thresholds_.hb_dist1 = thresh["hb_dist1"];
        if (thresh.contains("hb_dist2")) thresholds_.hb_dist2 = thresh["hb_dist2"];
        if (thresh.contains("hb_atoms")) thresholds_.hb_atoms = thresh["hb_atoms"];
        if (thresh.contains("overlap_threshold")) thresholds_.overlap_threshold = thresh["overlap_threshold"];
        if (thresh.contains("helix_break")) thresholds_.helix_break = thresh["helix_break"];
    }
