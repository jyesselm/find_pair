...
ResidueType ResidueFactory::determine_type(const std::string& name, char one_letter_code) {
    ...
    if (one_letter_code == 'A') return ResidueType::ADENINE;
    if (one_letter_code == 'C') return ResidueType::CYTOSINE;
    if (one_letter_code == 'G') return ResidueType::GUANINE;
    if (one_letter_code == 'T') return ResidueType::THYMINE;
    if (one_letter_code == 'U') return ResidueType::URACIL;
    if (one_letter_code == 'I') return ResidueType::INOSINE;
    if (one_letter_code == 'P') return ResidueType::PSEUDOURIDINE;
