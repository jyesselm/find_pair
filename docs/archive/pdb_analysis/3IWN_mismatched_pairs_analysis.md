# Mismatched Pairs Analysis: 3IWN

Generated: 2025-11-26 20:42:58

## Summary

- **Missing Pairs (in legacy but not modern)**: 1
- **Extra Pairs (in modern but not legacy)**: 1
...
**Quality Scores**:
- Base Score: Legacy=12.182162, Modern=12.182162 (diff=0.000000)
- adjust_pairQuality: Legacy=-0.000000, Modern=-0.000000 (diff=0.000000)
- bp_type_id: Legacy=-1, Modern=0
- Final Score: Legacy=12.182162, Modern=12.182162 (diff=0.000000)
