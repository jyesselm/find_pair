...
std::vector<Phase1Debug> trace_phase1(std::vector<HydrogenBondResult>& hbonds, double /*hb_lower*/,
                                      double /*hb_dist2*/) {
...
int main(int argc, char* argv[]) {
    ...
    if (base1 == '?') {
        ...
        if (type1 == ResidueType::ADENINE)
            base1 = 'A';
        else if (type1 == ResidueType::CYTOSINE)
            base1 = 'C';
        else if (type1 == ResidueType::GUANINE)
            base1 = 'G';
        else if (type1 == ResidueType::THYMINE)
            base1 = 'T';
        else if (type1 == ResidueType::URACIL)
            base1 = 'U';
    }
    if (base2 == '?') {
        auto type2 = res2->residue_type();
        if (type2 == ResidueType::ADENINE)
            base2 = 'A';
        else if (type2 == ResidueType::CYTOSINE)
            base2 = 'C';
        else if (type2 == ResidueType::GUANINE)
            base2 = 'G';
        else if (type2 == ResidueType::THYMINE)
            base2 = 'T';
        else if (type2 == ResidueType::URACIL)
            base2 = 'U';
    }
