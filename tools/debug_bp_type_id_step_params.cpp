...
int main(int argc, char* argv[]) {
    ...
    bool condition_met = (validation_result.dir_x > 0.0 && 
                          validation_result.dir_y < 0.0 && 
    ...
    switch (res1->residue_type()) {
        case core::ResidueType::ADENINE: base1_char = 'A'; break;
        case core::ResidueType::CYTOSINE: base1_char = 'C'; break;
        case core::ResidueType::GUANINE: base1_char = 'G'; break;
        case core::ResidueType::THYMINE: base1_char = 'T'; break;
        case core::ResidueType::URACIL: base1_char = 'U'; break;
        default: base1_char = '?'; break;
    }
    
    switch (res2->residue_type()) {
        case core::ResidueType::ADENINE: base2_char = 'A'; break;
        case core::ResidueType::CYTOSINE: base2_char = 'C'; break;
        case core::ResidueType::GUANINE: base2_char = 'G'; break;
        case core::ResidueType::THYMINE: base2_char = 'T'; break;
        case core::ResidueType::URACIL: base2_char = 'U'; break;
        default: base2_char = '?'; break;
    }
    ...
    if (std::abs(shear) >= 1.8 && std::abs(shear) <= 2.8) {
        bp_type_id = 1; // Wobble
        std::cout << "Wobble pair detected: abs(shear) = " << std::abs(shear) 
                  << " in [1.8, 2.8]\n";
    }
